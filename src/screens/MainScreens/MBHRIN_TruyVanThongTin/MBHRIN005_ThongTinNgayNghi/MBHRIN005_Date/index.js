...
const MBHRIN005_Date = ({ navigation, route }) => {
  ...
  const getData = () => {
    console.log("=== getData called (Date) ===");
    ...
    sysFetch(
      API_URL,
      {
        pro: "STV_HR_SEL_MBI_HRIN005_2_100", // Tổng hợp
        in_par: in_par,
        out_par: {
          p1_sys: "ngaynghi_summary",
        },
      },
      tokenLogin
    )
      .then((rs) => {
        ...
        if (rs === "Token Expired") {
          ...
          setDataNgayNghi(rs.data.ngaynghi_summary || []);
        } else {
    ...
    <View key={index} style={[styles.holidayItem, {
      ...
      <View style={styles.holidayDetails}>
        <View style={styles.holidayDetailRow}>
          ...
          <Text style={[styles.holidayDetailValue, { color: colors.primary }]}>
            {item.totalDays || '0'} ngày
          </Text>
        </View>
        ...
        <View style={styles.holidayDetailRow}>
          ...
          <Text style={[styles.holidayDetailValue, { color: colors.success }]}>
            {item.usedDays || '0'} ngày
          </Text>
        </View>
        ...
        <View style={styles.holidayDetailRow}>
          ...
          <Text style={[styles.holidayDetailValue, { color: colors.warning }]}>
            {item.remainingDays || '0'} ngày
          </Text>
        </View>
      </View>
